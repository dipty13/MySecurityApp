...
public class InCompleteTransaction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_in_complete_transaction);

        mRecyclerView = findViewById(R.id.inCompleteRecyclerView);
       ...
       /* for(int i=0;i<=10;i++)
        {
            ListInCompleteItem listItem = new ListInCompleteItem(
                    "Heading"+ (i+1),
                    "description....."
            );
        ...
        mAdapter = new MyInCompleteAdapter(mListItems,this);
