...
public class Profile extends AppCompatActivity {
    ...
    private CircleImageView mProfileImage,mNavProfileImage;
       ...
       /* mMapDatabaseReference = FirebaseDatabase.getInstance().getReference().child("Saved_location").child(onlineUserId);
        ...
        navView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    Intent locationIntent = new Intent(Profile.this, EditSafeLocation.class);
                    startActivity(locationIntent);
                    Toast.makeText(Profile.this,"Safe Location",Toast.LENGTH_LONG).show();
                }
